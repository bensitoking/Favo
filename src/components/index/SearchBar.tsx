...
export const SearchBar = () => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-full max-w-3xl mx-auto p-1 transition-all duration-300 hover:shadow-xl">
      <div className="flex items-center">
        ...
        <Link to={`/demanda?q=${encodeURIComponent(searchTerm)}`}>
          <button 
